...
project(nnef-lib C)
file(GLOB OVX_SRC_NNEF_LIB "${KHRONOS_SRC_DIR}/kernels/nnef/NNEF-Tools/nnef-pyproject/nnef/cpp/src/*.cpp")
add_library(nnef-lib STATIC ${OVX_SRC_NNEF_LIB} )
target_include_directories(nnef-lib  PRIVATE ${KHRONOS_SRC_DIR}/kernels/nnef/NNEF-Tools/nnef-pyproject/nnef/cpp/include)
openvx_target_setup(nnef-lib)
...
if (OPENVX_CONFORMANCE_NNEF_IMPORT)
target_link_libraries(openvx PRIVATE openvx-helper vx_debug nnef-lib)
target_include_directories(openvx PUBLIC ${KHRONOS_SRC_DIR}/include PRIVATE ${KHRONOS_SRC_DIR}/sample/include ${KHRONOS_SRC_DIR}/kernels/nnef/NNEF-Tools/nnef-pyproject/nnef/cpp/include)
else ()
